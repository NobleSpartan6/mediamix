 ...
 */
export const Slider = React.forwardRef<HTMLSpanElement, SliderProps>(({ className = '', ...props }, ref) => (
  <RadixSlider.Root
    ref={ref}
  ...
  >
    ...
    <RadixSlider.Thumb className="block w-3 h-3 bg-white shadow rounded-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent" />
  </RadixSlider.Root>
))
